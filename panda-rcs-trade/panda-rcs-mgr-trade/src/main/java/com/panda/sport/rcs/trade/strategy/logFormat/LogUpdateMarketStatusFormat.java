...
public class LogUpdateMarketStatusFormat extends LogFormatStrategy {
    ...
    private RcsOperateLog updateMarketStatusFormat(RcsOperateLog rcsOperateLog, MarketStatusUpdateVO vo) {
        ...
        if (matchName.trim().equals("(主)VS")) {
            setMatchName(vo.getTeamList());
        }
        switch (vo.getTradeLevel()) {
            ...
            case 2:
                ...
                rcsOperateLog.setObjectNameByObj(getPlayName(
                        vo.getCategoryId(),
                        Math.toIntExact(vo.getSportId()),
                        Objects.nonNull(vo.getAddition1()) ? vo.getAddition1() : "",
                        Objects.nonNull(vo.getAddition2()) ? vo.getAddition2() : ""));
            ...
            case 3:
                ...
                if (Objects.nonNull(vo.getMarketId())) {
                    ...
                    rcsOperateLog.setObjectNameByObj(
                            Objects.nonNull(vo.getMarketValue()) ?
                                    transMarketValue(new BigDecimal(vo.getMarketValue())) : OperateLogEnum.NONE.getName());
                } else {
                    rcsOperateLog.setObjectIdByObj(vo.getCategoryId());
                    rcsOperateLog.setObjectNameByObj(getPlayName(
                            vo.getCategoryId(),
                ...
                StringBuilder extObjectName = new StringBuilder(matchName).append(" / ").append(getPlayName(
                        vo.getCategoryId(),
                        Math.toIntExact(vo.getSportId()),
                        Objects.nonNull(vo.getAddition1()) ? vo.getAddition1() : "",
                        Objects.nonNull(vo.getAddition2()) ? vo.getAddition2() : ""));
