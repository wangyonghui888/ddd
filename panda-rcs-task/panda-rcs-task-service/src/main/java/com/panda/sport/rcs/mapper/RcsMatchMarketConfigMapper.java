...
import com.panda.sport.rcs.pojo.BuildMarketPlaceConfig;
...
public interface RcsMatchMarketConfigMapper extends BaseMapper<RcsMatchMarketConfig> {
     ...
     * @return void
     **/
    void insertOrUpdateMarketConfigSub(@Param("config") RcsMatchMarketConfigSub config);

    void insertBatchMarketConfigSub(@Param("list") List<RcsMatchMarketConfigSub> list);

    void updateMarketConfigSub(@Param("config")RcsMatchMarketConfig config);
...
//     * @Param [map]
//     * @Author  Sean
//     * @Date  10:45 2020/9/19
//     * @return void
//     **/
//	void updateAllMarketToZeroByMatchId(Map<String, Object> map);

    RcsMatchMarketConfigSub queryMatchMarketConfigSub(@Param("config")RcsMatchMarketConfig config);
}
