...
public interface TOrderDetailMapper extends BaseMapper<TOrderDetail> {
     ...
     * @Description 从某个时候开始，哪些投注项有新的注单进来
     * @Param [sportId, beginTime, matchType]
     * @Author kimi
     * @Date 2020/7/7
     **/
    List<OrderSummaryVo> getTOrderDetailUpBetTime(@Param("sportId") long sportId, @Param("matchType") int matchType, @Param("oddsId") List<Long> oddsId);

    /**
     * @return java.util.List<java.lang.Long>
     * @Description //TODO
     * @Param [sportId, beginTime, endTime]
     * @Author kimi
     * @Date 2020/7/15
     **/
    List<Long> getOddsId(@Param("sportId") long sportId, @Param("beginTime") long beginTime, @Param("endTime") long endTime);
}
