...
public interface MarketCategorySetMapper extends BaseMapper<RcsMarketCategorySet> {
     ...
     * @return
     */
    List<CategoryConVo> selectCategorySet(@Param("sportId")Long sportId,@Param("categoryConId")Long categoryConId);
     ...
     * @return
     */
    List<CategoryConVo> queryScopeCategory(@Param("sportId")Long sportId);
     ...
     * @return
     */
    List<Long> queryCategoryIds(@Param("sportId")Long sportId,@Param("playSetCode")String playSetCode);
}
