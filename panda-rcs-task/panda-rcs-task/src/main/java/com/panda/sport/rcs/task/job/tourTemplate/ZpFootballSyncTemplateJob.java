...
@Component
@Slf4j
@JobHandler(value = "zpFootballSyncTemplateJobHandler")
public class ZpFootballSyncTemplateJob  extends IJobHandler {
    ...
    public ZpFootballSyncTemplateJob(RcsTournamentTemplatePlayMargainRefMapper playMargainRefMapper,RedissonManager redissonManager,
    ...
    public ReturnT<String> execute(String s) throws Exception {
        ...
        try {
            ...
            List<RcsTournamentTemplateComposeModel> zpList = playMargainRefMapper.selectAllZPTemplatesByFoot();
            improveFootballSyncTemplate.syncTemplate(zpList,linkId,redis_data_key_zp);
        }catch (Exception e) {
