 ...
 * @since 2020-06-24
 */
public interface RiskUserVisitIpMapper extends BaseMapper<RiskUserVisitIp> {
    /**
     ...
     **/
    List<RiskUserVisitIp> queryByUserIdAndLoginDate(@Param("userId") Long userId,@Param("loginDate") Long loginDate);
