 ...
 * --------  ---------  --------------------------
 */
@ApiModel(value = "投注偏好详情/财务特征详情-投注阶段返回vo", description = "")
public class ListByBetStageResVo {
    @ApiModelProperty(value = "类型")
    private String betStageName;
    ...
    public String getBetStageName() {
        return betStageName;
    }

    public void setBetStageName(String betStageName) {
        this.betStageName = betStageName;
    }
    ...
    public BigDecimal getProfitRate() {
        if(profitRate == null) {return BigDecimal.ZERO;}
        return profitRate;
    }
