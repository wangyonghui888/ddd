...
public class I18nBean implements Serializable {
    ...
    public static String HOME_POSITION = "home";

    public static String AWAY_POSITION = "away";
    ...
    public void replaceTeam(Map<String, I18nBean> teamMap) {
        if (CollectionUtils.isEmpty(teamMap)) {
            teamMap.put(HOME_POSITION, BeanFactory.getHomeTeam());
            teamMap.put(AWAY_POSITION, BeanFactory.getAwayTeam());
        }
        I18nBean homeTeam = teamMap.get(HOME_POSITION);
        if (homeTeam == null) {
            homeTeam = BeanFactory.getHomeTeam();
        }
        I18nBean awayTeam = teamMap.get(AWAY_POSITION);
        if (awayTeam == null) {
    ...
    public static I18nBean getHome(Map<String, I18nBean> teamMap) {
        ...
        I18nBean bean = teamMap.getOrDefault(HOME_POSITION, BeanFactory.getHomeTeam());
    ...
    public static I18nBean getAway(Map<String, I18nBean> teamMap) {
        ...
        I18nBean bean = teamMap.getOrDefault(AWAY_POSITION, BeanFactory.getAwayTeam());
        if (StringUtils.isBlank(bean.getZs()) && StringUtils.isNotBlank(bean.getEn())) {
            bean.setZs(bean.getEn());
        }
        return bean;
