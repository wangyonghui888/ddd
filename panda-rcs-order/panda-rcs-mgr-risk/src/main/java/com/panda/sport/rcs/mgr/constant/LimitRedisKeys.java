...
public interface LimitRedisKeys {
     ...
     * 赛事模板用户单场限额缓存key
     */
    String MATCH_SINGLE_LIMIT_KEY = "rcs:limit:sportId.%s:dataType.%s:matchId.%s:UserSingle";
    /**
     * 用户模板用户单场限额缓存key
     */
     ...
     * 赛事模板商户单场限额缓存key
     */
    String MATCH_MERCHANT_SINGLE_LIMIT_KEY = "rcs:limit:sportId.%s:dataType.%s:matchId.%s:MerchantSingle";
    /**
     * 商户模板单场限额缓存key
     */
    ...
    String MERCHANT_ALERT_KEY = "rcs:sdk:over:num:matchId:%s";
    ...
    static String getMerchantAlertKey(String matchId) {
        return String.format(MERCHANT_ALERT_KEY,matchId);
    }
    ...
    static String getMatchSingleLimitKey(String sportId, LimitDataTypeEnum limitDataTypeEnum, String matchId, String isScroll) {
        return String.format(MATCH_SINGLE_LIMIT_KEY, sportId, limitDataTypeEnum.getType(), matchId);
    }
    ...
    static String getMatchMerchantSingleLimitKey(String sportId, LimitDataTypeEnum limitDataTypeEnum, String matchId, String isScroll) {
        return String.format(MATCH_MERCHANT_SINGLE_LIMIT_KEY, sportId, limitDataTypeEnum.getType(), matchId);
    }
    ...
    static String getMerchantSingleMatchHashKey(String dateExpect, String businessId, String sportId, String matchId, String matchType) {
        return String.format(singleMatchInfoKey, dateExpect, businessId, sportId, matchId, businessId, matchId, matchType);
    }
