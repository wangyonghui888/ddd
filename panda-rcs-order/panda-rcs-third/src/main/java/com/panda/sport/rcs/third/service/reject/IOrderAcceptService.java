package com.panda.sport.rcs.third.service.reject;
...
public interface IOrderAcceptService {
     ...
     * @return 是否滚球订单
     */
    boolean orderIsScroll(List<ExtendBean> list);
     ...
     * @return 变动范围
     */
    Map<String, String> queryOddsRange(List<TOrderDetail> list, String third);
