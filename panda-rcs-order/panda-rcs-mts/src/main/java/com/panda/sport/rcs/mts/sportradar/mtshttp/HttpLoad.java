package com.panda.sport.rcs.mts.sportradar.mtshttp;
...
public class HttpLoad {
	...
	public void initHttpClient() {
		...
		// 设置连接池最大数量
		httpClientConnectionManager.setMaxTotal(1500);
		// 设置单个路由最大连接数量
		httpClientConnectionManager.setDefaultMaxPerRoute(1500);
	...
	public CloseableHttpClient getHttpClient() {
		// 创建全局的requestConfig
		RequestConfig requestConfig = RequestConfig.custom().setConnectTimeout(2500).setSocketTimeout(2500).setConnectionRequestTimeout(2500)
		...
		CloseableHttpClient httpClient = HttpClients.custom().setConnectionManager(httpClientConnectionManager)
				...
				.setRetryHandler(myRetryHandler).useSystemProperties().build();
		return httpClient;
	}
