...
public class BaseUtils {
     ...
     * @return
     */
    public static Map<Integer, BigDecimal> calTotalEuOdds(List<Selection> orderItemList) {
    ...
    private static BigDecimal getOdds(Selection orderItem) {
        Double oddsValue = orderItem.getOdds();
        if (oddsValue == null) {
