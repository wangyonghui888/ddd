    ...
    descriptor = com.google.protobuf.Descriptors.FileDescriptor
      .internalBuildGeneratedFileFrom(descriptorData,
        new com.google.protobuf.Descriptors.FileDescriptor[] {
          ...
          TicketCancel.getDescriptor(),
          PlayerRiskScore.getDescriptor(),
          ResolveForeignEventsInTicket.getDescriptor(),
          TicketAck.getDescriptor(),
          TicketMaxStake.getDescriptor(),
          TicketResultOuterClass.getDescriptor(),
        });
    TicketOuterClass.getDescriptor();
    TicketCancel.getDescriptor();
    PlayerRiskScore.getDescriptor();
