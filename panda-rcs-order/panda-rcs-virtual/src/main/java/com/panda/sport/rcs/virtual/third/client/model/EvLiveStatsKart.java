...
/**
 * Information about the live stats of Kart event. 
 */
@ApiModel(description = "Information about the live stats of Kart event. ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T13:53:10.996Z")



public class EvLiveStatsKart extends EvLiveStats {
  ...
  public EvLiveStatsKart result(List<Integer> result) {
    this.result = result;
    return this;
  }

  public EvLiveStatsKart addResultItem(Integer resultItem) {
    if (this.result == null) {
  ...
  **/
  ...
  public EvLiveStatsKart resultDate(OffsetDateTime resultDate) {
  ...
  **/
  ...
  public EvLiveStatsKart videoSelected(String videoSelected) {
  ...
  **/
  ...
  public EvLiveStatsKart videoEvents(List<Integer> videoEvents) {
    this.videoEvents = videoEvents;
    return this;
  }

  public EvLiveStatsKart addVideoEventsItem(Integer videoEventsItem) {
  ...
  **/
  ...
  public EvLiveStatsKart videoDuration(BigDecimal videoDuration) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EvLiveStatsKart evLiveStatsKart = (EvLiveStatsKart) o;
    return Objects.equals(this.result, evLiveStatsKart.result) &&
        Objects.equals(this.resultDate, evLiveStatsKart.resultDate) &&
        Objects.equals(this.videoSelected, evLiveStatsKart.videoSelected) &&
        Objects.equals(this.videoEvents, evLiveStatsKart.videoEvents) &&
        Objects.equals(this.videoDuration, evLiveStatsKart.videoDuration) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class EvLiveStatsKart {\n");
