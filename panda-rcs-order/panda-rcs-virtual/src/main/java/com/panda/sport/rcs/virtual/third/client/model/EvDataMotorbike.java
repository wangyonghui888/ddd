...
import com.panda.sport.rcs.virtual.third.client.model.EvMotorbikeEventParticipant;
import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

/**
 * Information about Motorbikes event. 
 */
@ApiModel(description = "Information about Motorbikes event. ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T13:53:10.996Z")



public class EvDataMotorbike extends EvData {
  @SerializedName("participants")
  private List<EvMotorbikeEventParticipant> participants = null;
  ...
  public EvDataMotorbike participants(List<EvMotorbikeEventParticipant> participants) {
    this.participants = participants;
    return this;
  }

  public EvDataMotorbike addParticipantsItem(EvMotorbikeEventParticipant participantsItem) {
    if (this.participants == null) {
      this.participants = new ArrayList<EvMotorbikeEventParticipant>();
    }
  ...
  **/
  ...
  public List<EvMotorbikeEventParticipant> getParticipants() {
    return participants;
  }

  public void setParticipants(List<EvMotorbikeEventParticipant> participants) {
    this.participants = participants;
  }

  public EvDataMotorbike type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public EvDataMotorbike trackCondition(Float trackCondition) {
  ...
  **/
  ...
  public EvDataMotorbike numParticipants(Integer numParticipants) {
  ...
  **/
  ...
  public EvDataMotorbike numPodium(Integer numPodium) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EvDataMotorbike evDataMotorbike = (EvDataMotorbike) o;
    return Objects.equals(this.participants, evDataMotorbike.participants) &&
        Objects.equals(this.type, evDataMotorbike.type) &&
        Objects.equals(this.trackCondition, evDataMotorbike.trackCondition) &&
        Objects.equals(this.numParticipants, evDataMotorbike.numParticipants) &&
        Objects.equals(this.numPodium, evDataMotorbike.numPodium) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class EvDataMotorbike {\n");
