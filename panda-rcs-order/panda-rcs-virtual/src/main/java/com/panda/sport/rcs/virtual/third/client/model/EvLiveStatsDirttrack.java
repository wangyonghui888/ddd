...
/**
 * Information about the live stats of Dirttrack event. 
 */
@ApiModel(description = "Information about the live stats of Dirttrack event. ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T13:53:10.996Z")



public class EvLiveStatsDirttrack extends EvLiveStats {
  ...
  public EvLiveStatsDirttrack result(List<Integer> result) {
    this.result = result;
    return this;
  }

  public EvLiveStatsDirttrack addResultItem(Integer resultItem) {
    if (this.result == null) {
  ...
  **/
  ...
  public EvLiveStatsDirttrack resultDate(OffsetDateTime resultDate) {
  ...
  **/
  ...
  public EvLiveStatsDirttrack videoSelected(String videoSelected) {
  ...
  **/
  ...
  public EvLiveStatsDirttrack videoEvents(List<Integer> videoEvents) {
    this.videoEvents = videoEvents;
    return this;
  }

  public EvLiveStatsDirttrack addVideoEventsItem(Integer videoEventsItem) {
  ...
  **/
  ...
  public EvLiveStatsDirttrack videoDuration(BigDecimal videoDuration) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EvLiveStatsDirttrack evLiveStatsDirttrack = (EvLiveStatsDirttrack) o;
    return Objects.equals(this.result, evLiveStatsDirttrack.result) &&
        Objects.equals(this.resultDate, evLiveStatsDirttrack.resultDate) &&
        Objects.equals(this.videoSelected, evLiveStatsDirttrack.videoSelected) &&
        Objects.equals(this.videoEvents, evLiveStatsDirttrack.videoEvents) &&
        Objects.equals(this.videoDuration, evLiveStatsDirttrack.videoDuration) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class EvLiveStatsDirttrack {\n");
