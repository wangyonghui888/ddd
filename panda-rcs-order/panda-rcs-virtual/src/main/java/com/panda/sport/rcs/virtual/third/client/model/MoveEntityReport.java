...
/**
 * Report that move entity from its current path to a new one.
 */
@ApiModel(description = "Report that move entity from its current path to a new one.")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T13:53:10.996Z")



public class MoveEntityReport extends Report {
  ...
  public String toString() {
    ...
    sb.append("class MoveEntityReport {\n");
