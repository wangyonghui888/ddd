...
import com.panda.sport.rcs.virtual.third.client.model.EvSpeedwayEventParticipant;
import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

/**
 * Information about Speedway event. 
 */
@ApiModel(description = "Information about Speedway event. ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T13:53:10.996Z")



public class EvDataSpeedway extends EvData {
  @SerializedName("participants")
  private List<EvSpeedwayEventParticipant> participants = null;
  ...
  public EvDataSpeedway participants(List<EvSpeedwayEventParticipant> participants) {
    this.participants = participants;
    return this;
  }

  public EvDataSpeedway addParticipantsItem(EvSpeedwayEventParticipant participantsItem) {
    if (this.participants == null) {
      this.participants = new ArrayList<EvSpeedwayEventParticipant>();
    }
  ...
  **/
  ...
  public List<EvSpeedwayEventParticipant> getParticipants() {
    return participants;
  }

  public void setParticipants(List<EvSpeedwayEventParticipant> participants) {
    this.participants = participants;
  }

  public EvDataSpeedway type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public EvDataSpeedway trackCondition(Float trackCondition) {
  ...
  **/
  ...
  public EvDataSpeedway numParticipants(Integer numParticipants) {
  ...
  **/
  ...
  public EvDataSpeedway numPodium(Integer numPodium) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EvDataSpeedway evDataSpeedway = (EvDataSpeedway) o;
    return Objects.equals(this.participants, evDataSpeedway.participants) &&
        Objects.equals(this.type, evDataSpeedway.type) &&
        Objects.equals(this.trackCondition, evDataSpeedway.trackCondition) &&
        Objects.equals(this.numParticipants, evDataSpeedway.numParticipants) &&
        Objects.equals(this.numPodium, evDataSpeedway.numPodium) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class EvDataSpeedway {\n");
