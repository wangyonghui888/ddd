...
/**
 * Motorbike Viewer Profile Game Settings 
 */
@ApiModel(description = "Motorbike Viewer Profile Game Settings ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T13:53:10.996Z")



public class MotorbikeViewerProfileGameSettings extends ViewerProfileGameSettings {
  /**
   * Amount of information to show in the layout of trifecta for 6 participants.  If you select LEGACY, all combinations of trifecta junt or odds will be displayed.  If COMPACT is selected, the 18 TRICAST (HIGHT and LOW) of the event will be  displayed along with their odds. 
   */
  ...
  public MotorbikeViewerProfileGameSettings trifectaLayout6paticipant(TrifectaLayout6paticipantEnum trifectaLayout6paticipant) {
  ...
  **/
  @ApiModelProperty(value = "Amount of information to show in the layout of trifecta for 6 participants.  If you select LEGACY, all combinations of trifecta junt or odds will be displayed.  If COMPACT is selected, the 18 TRICAST (HIGHT and LOW) of the event will be  displayed along with their odds. ")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    MotorbikeViewerProfileGameSettings motorbikeViewerProfileGameSettings = (MotorbikeViewerProfileGameSettings) o;
    return Objects.equals(this.trifectaLayout6paticipant, motorbikeViewerProfileGameSettings.trifectaLayout6paticipant) &&
        super.equals(o);
  }

  @Override
  public int hashCode() {
    return Objects.hash(trifectaLayout6paticipant, super.hashCode());
  }
  ...
  public String toString() {
    ...
    sb.append("class MotorbikeViewerProfileGameSettings {\n");
