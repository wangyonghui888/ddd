...
/**
 * Super 7 custom data for eventblock. 
 */
@ApiModel(description = "Super 7 custom data for eventblock. ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T13:53:10.996Z")



public class S7EventBlockData extends EventBlockData {
  ...
  public S7EventBlockData croupierName(String croupierName) {
  ...
  **/
  ...
  public S7EventBlockData videoUrl(String videoUrl) {
  ...
  **/
  ...
  public S7EventBlockData presenterVideoUrl(String presenterVideoUrl) {
  ...
  **/
  ...
  public S7EventBlockData presenterImageUrl(String presenterImageUrl) {
  ...
  **/
  ...
  public S7EventBlockData placeBetsIdentUrl(String placeBetsIdentUrl) {
  ...
  **/
  ...
  public S7EventBlockData betsClosedIdentsUrl(String betsClosedIdentsUrl) {
  ...
  **/
  ...
  public S7EventBlockData gameIdentUrl(String gameIdentUrl) {
  ...
  **/
  ...
  public S7EventBlockData drawDate(OffsetDateTime drawDate) {
  ...
  **/
  ...
  public S7EventBlockData updateDate(OffsetDateTime updateDate) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    S7EventBlockData s7EventBlockData = (S7EventBlockData) o;
    return Objects.equals(this.croupierName, s7EventBlockData.croupierName) &&
        Objects.equals(this.videoUrl, s7EventBlockData.videoUrl) &&
        Objects.equals(this.presenterVideoUrl, s7EventBlockData.presenterVideoUrl) &&
        Objects.equals(this.presenterImageUrl, s7EventBlockData.presenterImageUrl) &&
        Objects.equals(this.placeBetsIdentUrl, s7EventBlockData.placeBetsIdentUrl) &&
        Objects.equals(this.betsClosedIdentsUrl, s7EventBlockData.betsClosedIdentsUrl) &&
        Objects.equals(this.gameIdentUrl, s7EventBlockData.gameIdentUrl) &&
        Objects.equals(this.drawDate, s7EventBlockData.drawDate) &&
        Objects.equals(this.updateDate, s7EventBlockData.updateDate) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class S7EventBlockData {\n");
