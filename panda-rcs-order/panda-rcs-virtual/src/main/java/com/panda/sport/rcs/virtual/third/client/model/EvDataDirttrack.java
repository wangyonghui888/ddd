...
import com.panda.sport.rcs.virtual.third.client.model.EvDirttrackEventParticipant;
import java.io.IOException;
import java.util.ArrayList;
import java.util.List;

/**
 * Information about Dirttrack event. 
 */
@ApiModel(description = "Information about Dirttrack event. ")
@javax.annotation.Generated(value = "io.swagger.codegen.languages.JavaClientCodegen", date = "2020-09-25T13:53:10.996Z")



public class EvDataDirttrack extends EvData {
  @SerializedName("participants")
  private List<EvDirttrackEventParticipant> participants = null;
  ...
  public EvDataDirttrack participants(List<EvDirttrackEventParticipant> participants) {
    this.participants = participants;
    return this;
  }

  public EvDataDirttrack addParticipantsItem(EvDirttrackEventParticipant participantsItem) {
    if (this.participants == null) {
      this.participants = new ArrayList<EvDirttrackEventParticipant>();
    }
  ...
  **/
  ...
  public List<EvDirttrackEventParticipant> getParticipants() {
    return participants;
  }

  public void setParticipants(List<EvDirttrackEventParticipant> participants) {
    this.participants = participants;
  }

  public EvDataDirttrack type(String type) {
    this.type = type;
    return this;
  }
  ...
  **/
  ...
  public EvDataDirttrack trackCondition(Float trackCondition) {
  ...
  **/
  ...
  public EvDataDirttrack numParticipants(Integer numParticipants) {
  ...
  **/
  ...
  public EvDataDirttrack numPodium(Integer numPodium) {
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    EvDataDirttrack evDataDirttrack = (EvDataDirttrack) o;
    return Objects.equals(this.participants, evDataDirttrack.participants) &&
        Objects.equals(this.type, evDataDirttrack.type) &&
        Objects.equals(this.trackCondition, evDataDirttrack.trackCondition) &&
        Objects.equals(this.numParticipants, evDataDirttrack.numParticipants) &&
        Objects.equals(this.numPodium, evDataDirttrack.numPodium) &&
        super.equals(o);
  }
  ...
  public String toString() {
    ...
    sb.append("class EvDataDirttrack {\n");
