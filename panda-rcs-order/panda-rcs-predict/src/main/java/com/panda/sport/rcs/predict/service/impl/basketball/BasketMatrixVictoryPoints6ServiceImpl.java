 ...
 **/
@Slf4j
@Service("basketMatrixVictoryPoints6Service")
public class BasketMatrixVictoryPoints6ServiceImpl implements BasketBallForecastService {
...
//                }
            if (i >= 1 && i <= 5) {
                ...
                if ("1And11+".equalsIgnoreCase(orderItem.getPlayOptions())) {//赢
                    amount = betAmount.multiply(new BigDecimal(String.valueOf(orderItem.getHandleAfterOddsValue())).subtract(new BigDecimal(1))).multiply(new BigDecimal("-1"));
                } else {
                    amount = betAmount;
                }
                ...
                if ("2And11+".equalsIgnoreCase(orderItem.getPlayOptions())) {//赢
                    amount = betAmount.multiply(new BigDecimal(String.valueOf(orderItem.getHandleAfterOddsValue())).subtract(new BigDecimal(1))).multiply(new BigDecimal("-1"));
                } else {
                    amount = betAmount;
                }
