 ...
 **/
@Slf4j
@Service("footPlaceNumLetPointForecastService")
public class FootPlaceNumLetPointForecastServiceImpl implements ForecastService {
    ...
    public void forecastData(OrderItem item, Integer type, boolean nx) {
        ...
        if (nx) {
            ...
            log.info("::{}::预测数据计算-玩法频率限制！本次跳过！", item.getOrderNo());
        }
