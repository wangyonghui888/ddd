 ...
 **/
@Slf4j
@Service("footPlayBigSmallForecastService")
public class FootPlayBigSmallForecastServiceImpl implements ForecastService {
    ...
    public void forecastData(OrderItem item, Integer type, boolean nx) {
        ...
        if (nx) {
            ...
            log.info("::{}::预测数据计算-大小球玩法频率限制！本次跳过 ", item.getOrderNo());
        }
