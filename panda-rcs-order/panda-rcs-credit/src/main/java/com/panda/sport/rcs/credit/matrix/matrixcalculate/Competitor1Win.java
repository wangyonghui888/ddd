...
@Service
@MatrixCacl(configs = "1:89")
public class Competitor1Win extends AbstractMatrix {

    /**
     * 玩法编码
     **/
    public static final String CATE_CODE = "89";
