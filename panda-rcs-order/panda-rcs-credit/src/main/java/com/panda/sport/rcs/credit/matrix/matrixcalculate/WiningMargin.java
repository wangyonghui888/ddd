 ...
 * @description :   净胜分
 * @date: 2020-03-19 9:57
 * @modificationHistory Who    When    What
 * --------  ---------  --------------------------
 */

@Service
@MatrixCacl(configs = "1:141;2:141")
public class WiningMargin extends AbstractMatrix {

    /**
     * 玩法编码
     **/
    public static final String CATE_CODE = "141";
     ...
     **/
    private final String templateName = "1And1,1And2,1And3+,2And1,2And2,2And3+,X,1And6+,2And6+,Other";
