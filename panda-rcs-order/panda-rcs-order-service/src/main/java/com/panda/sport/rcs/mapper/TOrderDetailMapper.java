...
public interface TOrderDetailMapper extends BaseMapper<TOrderDetail> {
    ...
    int insertOrderDetail(@Param("list") List<TOrderDetail> orderDetailList);
    ...
    IPage<OrderDetailVo> selectTOrderDetailByMarketIdPage(IPage<OrderDetailVo> page, @Param("matchId") Long matchId, @Param("playId") Integer playId,
                                                          @Param("marketId") Long marketId, @Param("oddsType") String oddsType, @Param("matchType") Integer matchType);
    ...
    List<ExtendBean> queryOrderDetails(@Param("orders") List<String> orderList);
    ...
    /**
     * @return int
     * @Description 批量跟新注单状态
     * @Param [List<Map>]
     * @Author magic
     * @Date 2022-08-30 11:06
     **/
    int updateBatchOrderDetailStatus(List<Map<String, Object>> list);
     ...
     * @return
     */
    List<TOrderDetail>  queryOrderDetails(@Param("orderNo")String orderNo);
}
