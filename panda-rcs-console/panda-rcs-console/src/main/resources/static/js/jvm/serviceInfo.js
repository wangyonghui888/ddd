...
//        this.$refs.loader.style.display = 'none';
    ...
    methods: {
            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    for(var i of myData) {
                        ...
                        var yy=parseInt(i.cpu);
                        //if (data1.length>30){$this.myData=data1; return; }
                        data1.push({
                            x: xx,
                            y: yy
                        });
        ...
        init9() {
            let $this = this;
            this.$http.get(api.serviceInfo.get).then(response => {
                            ...
                            events: {
                                load: function () {
                                    ...
                                    setInterval(function () {
                                        $this.$http.post(api.serviceInfo.get,{"one":1,"serverName":$this.serverName}).then(response => {
                                            if (response.body.code == 200) {
