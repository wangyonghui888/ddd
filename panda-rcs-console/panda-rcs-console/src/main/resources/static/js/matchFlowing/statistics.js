...
$(function() {
    layui.use('table', function(){
        ...
        tableIns=table.render({
            elem: '#uesrList',
            url:'/matchFlowing/getStatisticsList',
            ...
            cols: [[
                {type:'numbers'}
                ,{field:'globalId', title:'链路id',align:'left'}
                ,{field:'oid', title:'id',align:'left'}
                ,{field:'standardMatchId', title: '标准赛事id',align:'left'}
                ,{field:'insertTime', title: 'insertTime',align:'left'}
                ,{field:'modifyTime', title: '更新时间',align:'left'}
                ,{field:'thirdMatchId', title: '第三方赛事id',align:'left'}
                ,{field:'matchLength', title: '预计比赛时长',align:'left'}
                ,{field:'sportId', title: '阶段比分',align:'left'}
                ,{field:'info', title: 'info',align:'left'}
                ,{field:'remainingTime', title: '比赛剩余时间',align:'left'}
                ,{field:'period', title: '比赛阶段',align:'left'}
                ,{field:'setCount', title: '比赛阶段个数',align:'left'}
                ,{field:'secondsMatchStart', title: '正计时间',align:'left'}
                ,{field:'remainingTime', title: '倒计时间',align:'left'}
