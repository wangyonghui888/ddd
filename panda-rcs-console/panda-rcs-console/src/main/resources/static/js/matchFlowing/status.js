...
$(function() {
    layui.use('table', function(){
        ...
        tableIns=table.render({
            elem: '#uesrList',
            url:'/matchFlowing/getStatusList',
            ...
            cols: [[
                ...
                ,{field:'beginTime', title: '比赛开始时间',align:'left'}
                ,{field:'sportId', title: '标准运动种类id',align:'left'}
                ,{field:'matchStatus', title: '赛事状态',align:'left'}
                ,{field:'neutralGround', title: '是否为中立场',align:'left'}
                ,{field:'dataSourceCode', title: '取值',align:'left'}
                ,{field:'thirdMatchSourceId', title: '第三方赛事原始id',align:'left'}
                ,{field:'parentId', title: '父赛事id',align:'left'}
                ,{field:'betStatus', title: '赛事可下注状态',align:'left'}
