...
$(function () {
    layui.use('table', function () {
        ...
        tableIns = table.render({
            elem: '#uesrList',
            url: '/matchFlowing/getRcsLogFomat',
            ...
            cols: [[
                ...
                , {field: 'logId', title: 'logId', align: 'left'}
                , {field: 'name', title: 'name', align: 'left'}
                , {field: 'newVal', title: '新值', align: 'left'}
                , {field: 'oldVal', title: '旧值', align: 'left', event: 'queryOdds'}
                , {field: 'dynamicBean', title: 'dynamicBean', align: 'left'}
                , {field: 'logDesc', title: '日志描述', align: 'left'}
                , {field: 'createTime', title: '创建时间', align: 'left'}
                , {field: 'ctrTime', title: '入库时间', align: 'left'}
            ]],
