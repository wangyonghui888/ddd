...
$(function () {
    layui.use('table', function () {
        ...
        tableIns = table.render({
            elem: '#uesrList',
            url: '/tradingRecords/getRcsMatchMarketConfigLogs',
            ...
            cols: [[
                ...
                , {field: 'match_id', title: '赛事id', align: 'left'}
                , {
                    field: 'trader_level', title: '操作级别', align: 'left', templet: function (d) {
                        if (d.trader_level == '1') {
                            return '赛事级别'
                        }
                        if (d.trader_level == '2') {
                ...
                , {field: 'targer_data', title: '操作数据id', align: 'left'}
                , {
                    field: 'data_source', title: '自动手动', align: 'left', templet: function (d) {
                        if (d.data_source == '0') {
                            return '自动'
                        }
                        if (d.data_source == '1') {
                ...
                , {
                    field: 'status', title: '开关封锁状态', align: 'left', templet: function (d) {
                ...
                , {field: 'crt_time', title: '修改时间', align: 'left'}
            ]],
