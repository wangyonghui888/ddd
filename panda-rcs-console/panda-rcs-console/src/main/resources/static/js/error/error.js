    ...
    layui.use('table', function(){
        ...
        tableIns=table.render({
            ...
            cols: [[
                ...
                , {field: 'currentDate', title: '错误发生时间', align: 'left', templet: function (d) {
                        return  transformTime2(d.currentDate);
                    }}
                , {field: 'logContent', title: '错误详情', align: 'left',cellMinWidth: 200}
