...
public interface TOrderDetailMapper extends BaseMapper<TOrderDetail> {
     ...
     **/
    String queryOptionValue(@Param("bean") OrderItem bean,@Param("languageType")String languageType);

    String queryPlayerOptionValue(@Param("playOptionsId") Long playOptionsId, @Param("languageType")String languageType);
     ...
     * @return
     */
    String queryOddsPlayer(@Param("playerId")Long playerId, @Param("languageType")String languageType);
}
