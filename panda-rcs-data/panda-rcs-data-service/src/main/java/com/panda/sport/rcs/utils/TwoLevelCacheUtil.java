...
public class TwoLevelCacheUtil {
    ...
    public static final String REDIS_PRE_KEY= "rcs:ws:keyCache:pandaRDS:%s";
    ...
    public String get(@NotNull String key, @NotNull Function<String,String> function){
        ...
        log.info(redisKey+"再验本地缓存:"+(CommonUtils.isBlankOrNull(ifPresent)?"空":"有值"));
        //--------------------------------testCode
