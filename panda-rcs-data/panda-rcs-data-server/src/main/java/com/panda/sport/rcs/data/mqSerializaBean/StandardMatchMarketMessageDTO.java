 ...
 * --------  ---------  --------------------------
 * @see com.panda.merge.dto.message.StandardMatchMarketMessage
 */
@Data
public class StandardMatchMarketMessageDTO implements Serializable {
	 ...
	 * 盘口投注项
	 */
	private List<StandardMarketMessageDTO> marketList;
}
