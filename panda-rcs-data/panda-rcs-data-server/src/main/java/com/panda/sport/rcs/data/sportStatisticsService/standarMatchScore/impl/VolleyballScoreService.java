...
@Slf4j
@Service
public class VolleyballScoreService extends AbstractScoreService {
            ...
            while (iterator.hasNext()) {
                ...
                if("setScore".equals(matchStatisticsInfoDetail.getCode())){
                    ...
                    if(null==data.getSecondNum()){
                        ...
                        log.info("volleyball-score,matchId{},period{},secondNum{}",data.getStandardMatchId(),period,rSecondNum);
                    }
                }
                if (period.equals("-1")) {
                    matchStatisticsInfoDetail.setFirstNum(0);
