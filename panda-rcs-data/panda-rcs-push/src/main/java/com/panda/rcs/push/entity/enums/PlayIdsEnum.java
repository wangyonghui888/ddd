...
//    play_4(4,3),//让球
    ...
    public static com.panda.rcs.push.entity.enums.PlayIdsEnum getPlayIdsEnum(Integer playId1){
        for (com.panda.rcs.push.entity.enums.PlayIdsEnum playIdsEnum: com.panda.rcs.push.entity.enums.PlayIdsEnum.values()){
    ...
    public static List<com.panda.rcs.push.entity.enums.PlayIdsEnum> getPlayIdsEnums(List<Integer> playTimeStages ){
        List<com.panda.rcs.push.entity.enums.PlayIdsEnum> playIdsEnumList=new ArrayList<>();
        for (com.panda.rcs.push.entity.enums.PlayIdsEnum playIdsEnum: com.panda.rcs.push.entity.enums.PlayIdsEnum.values()){
