...
public enum  SubscriptionEnums {
    ...
    MATCH_SPEC_EVENT_SWITCH(30071,"特殊事件是否切换通知"),
    AO_AUTO_OPEN_MARKET_CONFIRM(30072,"AO玩法自动开盘确认通知"),
    MATCH_STAGE_BACK(30075,"回退赛事阶段通知");
    private Integer key;
     ...
     * @return 返回当前枚举
     */
    public static com.panda.rcs.push.entity.enums.SubscriptionEnums getSubscriptionEnums(Integer key) {
        com.panda.rcs.push.entity.enums.SubscriptionEnums[] allSubArr = com.panda.rcs.push.entity.enums.SubscriptionEnums.values();
        for (com.panda.rcs.push.entity.enums.SubscriptionEnums em : allSubArr) {
