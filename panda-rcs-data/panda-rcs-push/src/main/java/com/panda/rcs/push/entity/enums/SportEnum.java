...
public enum SportEnum {
     ...
     * @return
     */
    public static com.panda.rcs.push.entity.enums.SportEnum getSportEnum(Integer sportId) {
        for (com.panda.rcs.push.entity.enums.SportEnum e : values()) {
     ...
     * @return 返回当前枚举
     */
    public static com.panda.rcs.push.entity.enums.SportEnum getValue(Integer key) {
        com.panda.rcs.push.entity.enums.SportEnum[] allSportArr = com.panda.rcs.push.entity.enums.SportEnum.values();
        for (com.panda.rcs.push.entity.enums.SportEnum em : allSportArr) {
