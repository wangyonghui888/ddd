...
/**
 * 操盤日誌(matchChangeEventSource)
 * 實時事件源
 */
@Component
public class LogChangeEventSourceFormat extends LogFormatStrategy {
    @Override
    ...
    private RcsOperateLog ChangeStatusFormat(RcsOperateLog rcsOperateLog, LogAllBean vo) {
        ...
        if (Objects.nonNull(vo.getDataSouceCode()) && !vo.getDataSouceCode().equals(vo.getBeforeParams().get("dataSouceCode"))) {
            ...
            rcsOperateLog.setBeforeValByObj(vo.getBeforeParams().get("dataSouceCode"));
