...
public class LogMarketDisableFormat extends LogFormatStrategy {
    ...
    public RcsOperateLog formatLogBean(RcsOperateLog rcsOperateLog, LogAllBean vo ) {
        ...
        StringBuilder objectName = new StringBuilder().append(getPlayNameZs(vo.getPlayId(),vo.getSportId())).append("(").append(marketValue).append(")");
        StringBuilder objectNameEn = new StringBuilder().append(getPlayNameEn(vo.getPlayId(),vo.getSportId())).append("(").append(marketValue).append(")");
        ...
        rcsOperateLog.setBeforeValByObj(getIsSeriesName(Integer.parseInt(vo.getBeforeParams().get("disableFlag").toString())));
