...
public enum AutoCloseMarketEnum {
    ...
    FIRST_DURING_OVERTIME_one(13, "第1节"),
    FIRST_DURING_OVERTIME_tow(14, "第2节"),
    FIRST_DURING_OVERTIME_tr(15, "第3节"),
    FIRST_DURING_OVERTIME_tre(16, "第4节"),
    FIRST_DURING_OVERTIME_trm(40, "加时"),
